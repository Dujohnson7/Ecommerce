package rw.ac.auca.ecommmerce.controller.address;
...
import rw.ac.auca.ecommmerce.core.address.service.IAddressService;
...
public class AddressController {
        ...
        public String updateRole(@RequestParam("id") String id, Model model){
            if(Objects.nonNull(id)){
                Address theAddress = addressService
                        .findAddressByIdAndState(UUID.fromString(id), Boolean.TRUE);
                if(Objects.nonNull(theAddress)){
