package rw.ac.auca.ecommmerce.controller.role;
...
import rw.ac.auca.ecommmerce.core.role.service.IRoleService;
...
public class RoleController {
    ...
    public String updateRole(@ModelAttribute("role") Role theRole,  Model model){
        if(Objects.nonNull(theRole)){
            System.out.println("The role: "+theRole);
            roleService.updateRole(theRole);
        }
        return "redirect:/role/search/all";
    }
